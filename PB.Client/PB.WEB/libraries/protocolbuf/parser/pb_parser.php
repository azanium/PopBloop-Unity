...
class PBParser
{
     ...
     * @param String $protofile - the protofilename with the path
		 * @param String $directory_path - directory where the generated file will be placed
     */
    public function parse($protofile, $directory_path = '')
    {
        ...
        array_pop($name);
        $name = join($name, '.');
        $this->_create_class_file($directory_path . 'pb_proto_' . $name . '.php');
    }

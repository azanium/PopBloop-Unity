...
?>
        ...
        ?>
          <div title="<?php echo $item['name']; ?>"
            ...
            style="width:54px; height:54px; margin:1px; float:left; text-align:center; cursor:pointer; background-color:<?php if($item['color'] != ''){ echo $item['color']; } else { echo '#000'; } ?>"><!--[  background-position:top; background-repeat:no-repeat; background-image:url('<?php echo $this->preview_dir . $item['preview_image']; ?>') ]-->
            <!--[*
            <div style="position:relative; top:100px;"><?php echo $item['name']; ?></div>
            *]-->
          </div>

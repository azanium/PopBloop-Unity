		...
		<div style="width:788px; margin: 0px auto;">
				...
				<div style="height:40px;">
					...
					<div style="width:70%; float:left; font-size:18px; color:#fff;">
						...
						<div style="float:left;width:40px; height:40px;">
							<img src="<?php echo $_SESSION['basepath']; ?>user_generated_data/profile_picture/<?php echo $this->user_property->profile_picture ?>" style="width:36px; height:36px; margin-top:4px; margin-right:4px;" />
						</div>
					</div>
				</div>
				
				<div class="top_menu hovered" id="top_menu_island" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/visit_the_island_normal.png) center bottom no-repeat;">&nbsp;</div>
				<div class="top_menu hovered" id="top_menu_items" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/our_items_normal.png) center bottom no-repeat;">&nbsp;</div>
				<div class="top_menu hovered" id="top_menu_avatar" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/edit_your_avatar_normal.png) center bottom no-repeat;">&nbsp;</div>
			</div>
			<div class="clear"></div>
			...
			<div class="right_pane">
				<div class="right_pane_top_menu">
					<div class="right_pane_top_menu_back hovered" id="goto-tab-home">&nbsp;</div>
					<div class="right_pane_top_menu_line">&nbsp;</div>
					<div class="clear"></div>
					
					<div id="items_container">
						<div class="right_pane_content hovered" id="goto-tab-features" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/item_bg_normal.png) center no-repeat;">
							<div class="right_pane_content_text">Feature</div>
						</div>
						<div class="right_pane_content hovered" id="goto-tab-style" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/item_bg_normal.png) center no-repeat;">
							<div class="right_pane_content_text">Style</div>
						</div>
					</div>
...
<div style="display:none;">
	...
	<div id="tab-style">
		...
		<div class="right_pane_content hovered" id="goto-tab-shoes" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/item_bg_normal.png) center no-repeat;">
			<div class="right_pane_content_text">Shoes</div>
		</div>
		<div class="right_pane_content hovered" id="goto-tab-body" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/item_bg_normal.png) center no-repeat;">
			<div class="right_pane_content_text">Dress</div>
		</div>
		<div class="right_pane_content hovered" id="goto-tab-pants" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/item_bg_normal.png) center no-repeat;">
			<div class="right_pane_content_text">Pants</div>
		</div>
	...
	<div id="tab-hat">
		<input type="hidden" name="tab-hat-previous-tab" id="tab-hat-previous-tab" value="tab-style" />

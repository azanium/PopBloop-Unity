	...
	<div class style="width:788px;">
		<div style="width:788px; margin: 0px auto;">
			<div class="top_banner" style="text-align:right;">
				...
				<div class="top_menu hovered" id="top_menu_island" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/edit_your_avatar_normal.png) center bottom no-repeat;">&nbsp;</div>

	...
	$(document).ready(function(){
		...
		jQuery('.top_menu').live({	// size: 152 x 43	=> 160 x 47, margin-top: 50px => 48px
			mouseup: function(){
				...
				// top_menu_island, top_menu_items, top_menu_avatar
				...
				switch(_id){
					case 'top_menu_island':
						...
						break;
					case 'top_menu_items':
						$('#top_menu_island').css('background-position', 'top left');
						$('#top_menu_island').css('width', '148px');

						$('#top_menu_avatar').css('background-position', 'top right');
	...
	<div class style="width:788px;">
		<div style="width:788px; margin: 0px auto;">
			<div class="top_banner" style="text-align:right;">
				...
				<div class="top_menu hovered" id="top_menu_avatar" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/cur_edit_your_avatar_normal.png) center bottom no-repeat;">&nbsp;</div>
				<a href="<?php echo $_SESSION['basepath']; ?>ui/user/avatar_editor_branditems"><div class="top_menu hovered" id="top_menu_items" style="background:url(<?php echo $_SESSION['basepath']; ?>images/fb.pages/airbotol/our_items_normal.png) center bottom no-repeat;">&nbsp;</div></a>

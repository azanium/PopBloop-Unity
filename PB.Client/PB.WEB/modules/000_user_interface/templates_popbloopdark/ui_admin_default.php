...
<head>
<title>LiloCity</title>
<link rel="shortcut icon" href="<?php print($this->basepath); ?>modules/000_user_interface/images/icons/favicon.admin.gif">
<link rel="stylesheet" type="text/css" href="<?php print($this->basepath); ?>modules/000_user_interface/css/default.css" media="screen" />
...
<link type="text/css" href="<?php print($this->basepath); ?>libraries/js/jquery.ui/css/custom-theme/jquery-ui-1.8.14.custom.css" rel="stylesheet" />	

...
//				$('#user_detail_dialog').html(data);
				...
				$('#avatarname').val(user_data.avatarname);
				$('#handphone').val(user_data.handphone);
				$('#twitter').val(user_data.twitter);
...
<div style="width: auto; min-height: 58.4px; height: auto; min-width:600px; " class="ui-dialog-content ui-widget-content" id="user_detail_dialog" 
  ...
  <table style="width:100%; text-align:left">
  	<tr>
    	<td style="width:150px">Avatar Name</td>
    	<td><input type="text" disabled="disabled" name="avatarname" id="avatarname" value="" /></td>
    </tr>
  	...
  	<tr>
    	<td style="width:150px">Handphone</td>
    	<td><input type="text" disabled="disabled" name="handphone" id="handphone" value="" /></td>
    </tr>
  	<tr>
    	<td style="width:150px">Twitter</td>
    	<td><input type="text" disabled="disabled" name="twitter" id="twitter" value="" /></td>
    </tr>
  	<tr>

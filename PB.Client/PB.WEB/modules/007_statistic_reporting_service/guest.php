...
/**
 * examples:
 * -to get online time for user rully, use: http://localhost/popbloop/report/guest/achievement/4df6e7192cbfd4e6c000fd9b/online_time/get
 * -to increase online time for user rully by 200ms, use: http://localhost/popbloop/report/guest/achievement/4df6e7192cbfd4e6c000fd9b/online_time/dec/200
 */
 
/**
 * Consider to use session_id instead of user_id for security reason!
 */

function report_guest_achievement($user_id = NULL, $achievement_type = NULL, $op = NULL, $value = NULL){

...
public var globalNoiseAmount : float = 0.125f;//0.075f;
public var globalNoiseAmountOnDamage : float = 0.01091343f;//-6.0f;

public var localNoiseAmount : float = 0.4939354f;//0.0f;

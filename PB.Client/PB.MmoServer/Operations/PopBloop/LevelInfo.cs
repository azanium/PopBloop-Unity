...
{
    public class LevelInfo : Operation
    {
        public LevelInfo(IRpcProtocol protocol, OperationRequest request)
        ...
        {
            var responseObjcet = new LevelInfoResponse { MaxCCU = 0, WorldName = this.WorldName };

...
public class Messages
{
    ...
    // Generic Messages
    public static string BROADCAST_MESSAGE = "msgBroadcast";

    // Redeem Code Email send
    public static string REDEEM_AVATAR_GENERATE = "msgRedeemAvatarGenerate";
    public static string REDEEM_SEND_EMAIL = "msgSendRedeemEmail";
    ...
    public static string GUI_DEBUG_FPS = "msgDebugFps";
    public static string GUI_DEBUG_DIAG = "msgDebugDiag";
    public static string GUI_DEBUG_CCU = "msgDebugCCU";
    ...
    public static string PLAYER_STOPMOVE = "msgPlayerStopMove";
    public static string PLAYER_INTERACTO = "msgPlayerInteractTo";
